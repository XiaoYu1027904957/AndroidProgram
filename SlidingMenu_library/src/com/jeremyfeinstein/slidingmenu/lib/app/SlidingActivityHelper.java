...
public class SlidingActivityHelper {
	...
	/**
	 * Finds a com.atguigu.beijingnews.view that was identified by the id attribute from the XML that was processed in onCreate(Bundle).
	 * 
	 * @param id the resource id of the desired com.atguigu.beijingnews.view
	 * @return The com.atguigu.beijingnews.view if found or null otherwise.
	 */
	...
	/**
	 * Register the above content com.atguigu.beijingnews.view.
	 *
	 * @param v the above content com.atguigu.beijingnews.view to register
	 * @param params LayoutParams for that com.atguigu.beijingnews.view (unused)
	 */
	...
	/**
	 * Set the activity content to an explicit com.atguigu.beijingnews.view. This com.atguigu.beijingnews.view is placed directly into the activity's com.atguigu.beijingnews.view
	 * hierarchy. It can itself be a complex com.atguigu.beijingnews.view hierarchy. When calling this method, the layout parameters
	 * of the specified com.atguigu.beijingnews.view are ignored. Both the width and the height of the com.atguigu.beijingnews.view are set by default to
	 * MATCH_PARENT. To use your own layout parameters, invoke setContentView(android.com.atguigu.beijingnews.view.View,
	 * android.com.atguigu.beijingnews.view.ViewGroup.LayoutParams) instead.
	 *
	 ...
	 * @param layoutParams Layout parameters for the com.atguigu.beijingnews.view. (unused)
	 */
	...
	/**
	 * Open the SlidingMenu and show the secondary menu com.atguigu.beijingnews.view. Will default to the regular menu
