...
public class CustomViewAbove extends ViewGroup {
	...
	private void completeScroll() {
		...
		if (needPopulate) {
			// Done with scroll, no longer want to cache com.atguigu.beijingnews.view drawing.
			setScrollingCacheEnabled(false);
	 ...
	 * @param checkV Whether the com.atguigu.beijingnews.view v passed should itself be checked for scrollability (true),
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		// Let the focused com.atguigu.beijingnews.view and/or our descendants get the key first
		return super.dispatchKeyEvent(event) || executeKeyEvent(event);
	}

	/**
	 * You can call this function yourself to have the scroll com.atguigu.beijingnews.view perform
	 * scrolling from a key event, just as if the event had been dispatched to
	 * it by the com.atguigu.beijingnews.view hierarchy.
	 *
