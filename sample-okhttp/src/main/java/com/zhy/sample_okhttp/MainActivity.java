...
//        url =3.125.219.144:8443/mobileConnect/MobileConnect/authLogin.action?systemid=100009&mobile=13260284063&pipe=2&reqtime=1422986580048&ispin=2";
    ...
    public void uploadFile(View view)
    {
         ...
         * 文件上传的路径
         */
        String url = "http://192.168.14.165:8080/FileUpload/FileUploadServlet";

        OkHttpUtils.post()//上传文件用post
                .addFile("mFile", "atguigu.png", file)//
                .url(url)//
                .params(params)//
                .headers(headers)//
                .build()//
    ...
    public void downloadFile(View view)
    {
        ...
        OkHttpUtils//
                ...
                .url(url)//
                .build()//
                .execute(new FileCallBack(Environment.getExternalStorageDirectory().getAbsolutePath()+"/okhttp", "atguigu.mp4")//
                {
